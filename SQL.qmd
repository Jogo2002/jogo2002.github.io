...
This plot compares the probability that a stop results in a citation. For each race category, differences across the three bars (cities) indicate cross-jurisdiction variation. Within each city, differences across race categories indicate that enforcement outcomes are not uniform across groups.
...
Warnings are often the alternative to citations, so interpreting this plot alongside the citation plot helps clarify how different jurisdictions resolve stops. If some groups have relatively higher citation rates and lower warning rates within a city, that suggests a tendency toward more punitive outcomes for those groups in that jurisdiction.
