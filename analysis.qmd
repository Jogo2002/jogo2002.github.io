...
This report analyzes Netflix movie and TV show descriptions using text mining techniques. The dataset, accessed from TidyTuesday (2021-04-20)
, includes thousands of titles from a variety of genres and regions, spanning many years. My goal is to uncover patterns in naming and description practices that reveal thematic or marketing trends.
...
ggplot(theme_counts, aes(x = theme, y = count, fill = theme)) +
  ...
  labs(
    ...
    y = "Count of Mentions",
    fill = "Theme",
    alt = "Bar chart showing total mentions of the words 'love', 'death', and 'mystery' across all Netflix descriptions. 
           Each bar represents the overall frequency of a theme, allowing comparison of how often these motifs appear 
           in Netflix title summaries."
  ) +
  theme_minimal()
...
```{r}
#| fig-alt: "Bar chart showing how often the words 'love', 'death', and 'mystery' appear in Netflix descriptions. 'Love' occurs most frequently by a large margin."
