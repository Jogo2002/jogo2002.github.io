...
- **Dataset Overview**: The Netflix dataset contains thousands of movie and TV show titles, descriptions, and metadata.
...
netflix_titles |> head() |> as_tibble()
```

![](NetflixDataPreview.png)
